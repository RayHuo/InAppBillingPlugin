...
public class InAppBillingPlugin extends CordovaPlugin {
	...
	private class GetAccessTokenTask extends AsyncTask<Void, Void, GetAccessTokenResult> {
		...
		protected void onPreExecute() {
			dialog = ProgressDialog.show(context, "Tips", "Getting access_token");
		}
	...
	private class GetPrepayIdTask extends AsyncTask<Void, Void, GetPrepayIdResult> {
		...
		@Override
		protected void onPreExecute() {
			dialog = ProgressDialog.show(context, "Tips", "Getting prepayId");
		}
	...
	private String genPackage(List<NameValuePair> params) {
		...
		return URLEncodeUtils.format(params, "utf-8") + "&sign=" + packageSign;
	}
	...
	private HttpClient getNewHttpClient() {
		try {
			...
			HttpParams params = new BasicHttpParmas();
